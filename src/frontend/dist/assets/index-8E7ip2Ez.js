...
const BadgeDollarSign = createLucideIcon("badge-dollar-sign", __iconNode$j);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const TESTIMONIALS = [
  {
    ...
    initials: "PS",
    color: "bg-rose-400",
    quote: "The vegetables are incredibly fresh! I ordered spinach and tomatoes and they arrived within 3 hours. Highly recommend!"
  },
  {
    name: "Rahul M.",
    location: "New Town",
    initials: "RM",
    color: "bg-blue-400",
    quote: "Finally, a service that delivers farm-fresh quality at reasonable prices. VEGIANO has become part of our weekly routine."
  },
  {
    name: "Anita D.",
    location: "Howrah",
    initials: "AD",
    color: "bg-purple-400",
    quote: "Excellent quality and super fast delivery. The broccoli and carrots were so fresh, you could tell they were just harvested!"
  }
];
...
function App() {
  ...
  useFadeIn();
  const prevCartOpen = reactExports.useRef(cartOpen);
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    if (cart.length > 0) {
      setOrderItems(
        cart.map((i) => `${i.name} x${i.qty} (${i.price}/${i.unit})`).join(", ")
      );
    }
  }, [cart]);
  ...
  const addToCart = reactExports.useCallback((product) => {
    setCart((prev) => {
      ...
      if (existing)
        return prev.map(
          (i) => i.id === product.id ? { ...i, qty: i.qty + 1 } : i
        );
  ...
  const updateQty = reactExports.useCallback((id, delta) => {
    setCart(
      (prev) => prev.map((i) => i.id === id ? { ...i, qty: i.qty + delta } : i).filter((i) => i.qty > 0)
    );
  }, []);
  const removeItem = reactExports.useCallback((id) => {
    setCart((prev) => prev.filter((i) => i.id !== id));
  }, []);
  const buildWhatsAppUrl = (message) => `https://wa.me/918293692735?text=${encodeURIComponent(message)}`;
  const handleCartOrder = () => {
    const items = cart.map((i) => `${i.name} x${i.qty} (${i.price}/${i.unit})`).join(", ");
...
Items: ${orderItems || "(please specify)"}`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen font-poppins overflow-x-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-vegiano-green text-white text-center py-2 px-4 text-xs sm:text-sm font-medium", children: [
      "🌿 Free delivery on orders above ₹299  |  Call us:",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+918293692735", className: "underline font-semibold", children: "+91 82936 92735" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                ...
                "data-ocid": "nav.link",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "w-6 h-6 fill-current" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tracking-wide", children: "VEGIANO" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden md:flex items-center gap-6 text-sm font-medium text-gray-700", children: NAV_LINKS.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { className: "w-5 h-5 text-gray-700" }),
                    cartCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "absolute -top-1 -right-1 h-5 w-5 p-0 flex items-center justify-center bg-vegiano-green text-white text-xs rounded-full border-2 border-white", children: cartCount })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-white border-t border-border px-4 pb-4 pt-2 flex flex-col gap-1", children: NAV_LINKS.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => scrollTo(l.id),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sheet, { open: cartOpen, onOpenChange: setCartOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      SheetContent,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SheetHeader, { className: "border-b border-border pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetTitle, { className: "flex items-center gap-2 text-vegiano-green", children: [
          ...
          cart.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { className: "w-12 h-12 opacity-30" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: "Your cart is empty" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-center", children: "Add some fresh vegetables to get started!" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto py-4 space-y-3", children: cart.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-medium text-vegiano-green", children: [
                      "₹",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-4 space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between font-semibold", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-vegiano-green text-lg", children: [
                  "₹",
                  cartTotal
                ] })
              ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "section",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-black/70 via-black/50 to-black/20" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-vegiano-green/90 text-white px-4 py-2 rounded-full text-sm font-medium mb-6 fade-in-up", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "w-4 h-4" }),
                " 100% Organic & Fresh"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6 fade-in-up stagger-1", children: [
                "Fresh from Farm to",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-300", children: "Your Doorstep" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/85 text-lg sm:text-xl mb-8 leading-relaxed fade-in-up stagger-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4 fade-in-up stagger-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block bg-vegiano-green-light text-vegiano-green px-3 py-1 rounded-full text-sm font-semibold mb-4 fade-in-up", children: "Our Story" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl sm:text-4xl font-bold text-gray-900 mb-6 fade-in-up stagger-1", children: [
            "Farm-Fresh Goodness,",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-vegiano-green", children: "Delivered Daily" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-gray-600 leading-relaxed", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fade-in-up stagger-2", children: "VEGIANO was born from a simple belief: everyone deserves access to truly fresh, healthy vegetables without paying inflated prices. We partner directly with over 50 dedicated farmers in and around Kolkata — from Rajarhat to Howrah — eliminating the middleman entirely." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "fade-in-up stagger-3", children: "Every vegetable you order is harvested within 24 hours of delivery. No cold storage for weeks, no chemical preservatives, no compromise — just the freshest produce nature can offer, straight to your kitchen." })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-6", children: [
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-vegiano-green", children: stat.value }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-600 mt-1 font-medium", children: stat.label })
            ]
          },
          stat.label
        )) })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "products", className: "py-20 bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block bg-vegiano-green-light text-vegiano-green px-3 py-1 rounded-full text-sm font-semibold mb-3 fade-in-up", children: "Fresh Picks" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold text-gray-900 uppercase tracking-wide fade-in-up stagger-1", children: "Our Fresh Vegetables" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-3 fade-in-up stagger-2", children: "Harvested fresh every morning, delivered to your door." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-6", children: PRODUCTS.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          ProductCard,
          {
            product: p,
            index: i,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "why-us", className: "py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block bg-vegiano-green-light text-vegiano-green px-3 py-1 rounded-full text-sm font-semibold mb-3 fade-in-up", children: "Our Promise" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold text-gray-900 uppercase tracking-wide fade-in-up stagger-1", children: "Why Choose VEGIANO?" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-8", children: WHY_ITEMS.map((item, i) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 bg-vegiano-green-light rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-vegiano-green transition-colors duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-8 h-8 text-vegiano-green group-hover:text-white transition-colors duration-300" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "order", className: "py-20 bg-vegiano-green", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold text-white uppercase tracking-wide fade-in-up", children: "Place Your Order" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-100 mt-3 fade-in-up stagger-1", children: "Fill in the form below and we'll connect via WhatsApp instantly." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "form",
          {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "label",
                  {
                    ...
                    children: [
                      "Items to Order",
                      cart.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 text-xs text-vegiano-green font-normal", children: "(pre-filled from cart)" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "delivery", className: "py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block bg-vegiano-green-light text-vegiano-green px-3 py-1 rounded-full text-sm font-semibold mb-3 fade-in-up", children: "Delivery" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold text-gray-900 uppercase tracking-wide fade-in-up stagger-1", children: "Delivery Information" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-vegiano-green-light rounded-2xl p-8 fade-in-up stagger-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-vegiano-green rounded-xl flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-6 h-6 text-white" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xl text-gray-900", children: "Areas We Serve" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: DELIVERY_AREAS.map((area) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-4 text-sm text-gray-600", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-vegiano-green-light rounded-2xl p-8 fade-in-up stagger-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-vegiano-green rounded-xl flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-6 h-6 text-white" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xl text-gray-900", children: "Delivery Timing" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl p-4 flex items-start gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "🌅" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-900", children: "Same Day Delivery" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl p-4 flex items-start gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "🌄" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-900", children: "Next Morning Delivery" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600", children: "Orders placed after 12:00 PM will be delivered the next morning by 9 AM." })
                ] })
              ] })
            ] })
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "testimonials", className: "py-20 bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block bg-vegiano-green-light text-vegiano-green px-3 py-1 rounded-full text-sm font-semibold mb-3 fade-in-up", children: "Happy Customers" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold text-gray-900 uppercase tracking-wide fade-in-up stagger-1", children: "What Our Customers Say" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-8", children: TESTIMONIALS.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex text-yellow-400 gap-0.5 mb-4", children: Array.from({ length: 5 }).map((_, j) => (
                // biome-ignore lint/suspicious/noArrayIndexKey: static decorative stars
                /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 fill-current" }, j)
              )) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-600 leading-relaxed mb-6 text-sm italic", children: [
                "“",
                t.quote,
                "”"
              ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block bg-vegiano-green-light text-vegiano-green px-3 py-1 rounded-full text-sm font-semibold mb-3 fade-in-up", children: "Get in Touch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold text-gray-900 uppercase tracking-wide fade-in-up stagger-1", children: "Contact Us" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: [
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-white rounded-xl flex items-center justify-center mb-3 shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: `w-6 h-6 ${item.iconColor}` }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1", children: item.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-900 text-sm", children: item.value })
              ]
            },
            item.label
          );
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-vegiano-beige border-t border-vegiano-beige-dark", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-vegiano-green font-bold text-xl mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "w-6 h-6 fill-current" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "VEGIANO" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-sm leading-relaxed", children: "Farm-fresh vegetables delivered to your doorstep. Pure, organic, and affordable." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-gray-900 mb-4 uppercase tracking-wide text-sm", children: "Quick Links" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-gray-900 mb-4 uppercase tracking-wide text-sm", children: "Our Vegetables" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-gray-900 mb-4 uppercase tracking-wide text-sm", children: "Contact" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm text-gray-600", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 shrink-0 mt-0.5 text-vegiano-green" }),
              " ",
              "+91 82936 92735"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-4 h-4 shrink-0 mt-0.5 text-vegiano-green" }),
              " ",
              "WhatsApp: +91 82936 92735"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 shrink-0 mt-0.5 text-vegiano-green" }),
              " ",
              "Kolkata, West Bengal"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-4 h-4 shrink-0 mt-0.5 text-vegiano-green" }),
              " ",
              "Mon–Sat, 7 AM – 8 PM"
            ] })
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "bg-vegiano-beige-dark mb-6" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-gray-500", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " VEGIANO. All rights reserved."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "Built with ❤️ using",
          " ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        ...
        "data-ocid": "nav.link",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-7 h-7 text-white fill-current" })
      }
    )
  ] });
}
function ProductCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `bg-white rounded-2xl overflow-hidden border border-border hover:shadow-card-hover hover:border-vegiano-green/20 transition-all duration-300 group fade-in-up stagger-${Math.min(index2 + 1, 6)}`,
      "data-ocid": `products.item.${index2 + 1}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden aspect-square bg-gray-50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: product.image,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 right-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-vegiano-green text-white text-xs font-semibold px-2.5 py-1 rounded-full", children: "Fresh Today" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-gray-900 text-base mb-1", children: product.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-vegiano-green font-bold text-lg mb-4", children: [
            product.price,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              type: "button",
              onClick: handleAdd,
              className: `w-full rounded-full h-9 text-sm font-semibold transition-all duration-300 ${added ? "bg-vegiano-green-light text-vegiano-green border border-vegiano-green" : "bg-vegiano-green hover:bg-vegiano-green-dark text-white"}`,
...
Service({
  ...
  "submitOrder": Func(
    [Text, Text, Text, Vec(Item), Float64],
    [],
    []
  )
});
